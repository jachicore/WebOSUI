...
//			console.log(trObj);
	...
	DataGrid.prototype.createToolBar=function(){
		...
		var	inputdata = $("<a href='javascript:void(0)' style='display:none' >批量导入</a>");
		var	outputdatacurr = $("<a href='javascript:void(0)'>导出当前页记录</a>");
		var	outputdataall = $("<a href='javascript:void(0)'>导出所有记录</a>");
	...
	var cont = '';
		...
		cont += "            <div class='page'>";
		cont += "                <a href='javascript:void(0)' class='page_a_btn'><span class='icon-pre'></span></a>";
		cont += "                <a href='javascript:void(0)' class='page_a_btn'><span class='icon-up'></span></a>";
		...
		cont += "                <a href='javascript:void(0)' class='page_a_btn'><span class='icon-down'></span></a>";
		cont += "                <a href='javascript:void(0)' class='page_a_btn'><span class='icon-last'></span></a>";
		cont += "                <div>";
	...
	DataGrid.prototype.hideColMenu = function(ParentObj){
			...
			for(var i=0; i<this.options.colTitle.length; i++){
				...
				option1 += "<a href='javascript:void(0)'><input type='checkbox' value='"+i+"' /><div class='line'></div>"+this.options.colTitle[i].title+"</a>";
					}else{
				option1 += "<a href='javascript:void(0)'><input type='checkbox' value='"+i+"' checked='checked' /><div class='line'></div>"+this.options.colTitle[i].title+"</a>";
						}
			}
			submitis= $("<a href='javascript:void(0)'>提交</a>");
